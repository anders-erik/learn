(function () {
    ...
    window.gapi.K = new Date().getTime(); /*
...
*/
    ...
    var sa = {},
        ta = function () {
            ...
            if (sa !== sa) throw Error("SafeHtml is not meant to be built directly");
            this.F = a;
        };
    ...
    var C = new B("OFF", Infinity),
        ua = new B("WARNING", 900),
        va = new B("CONFIG", 700),
        wa = function () {
            this.g = 0;
            this.clear();
    ...
    var G = function (a, b, c) {
        this.reset(a || C, b, c, void 0, void 0);
    };
    ...
    var xa = function (a, b) {
        ...
        I = function (a, b) {
            var c = a.entries[b];
            if (c) return c;
            c = I(a, b.slice(0, Math.max(b.lastIndexOf("."), 0)));
            var d = new xa(b, c);
            a.entries[b] = d;
            c.children.push(d);
            return d;
...
*/
            ...
            if ((b = I(J(), "safevalues").D)) {
                ...
                if (a) {
                    ...
                    if (0 < e.g) {
                        var f = (e.o + 1) % e.g;
                        e.o = f;
                        e.s ? ((e = e.l[f]), e.reset(d, c, b), (b = e)) : ((e.s = f == e.g - 1), (b = e.l[f] = new G(d, c, b)));
                    } else b = new G(d, c, b);
                    za(a, b);
                }
            }
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var Ma = function (a, b, c) {
        ...
        U = function (a, b, c) {
            b && 0 < b.length && ((b = Na(b)), c && 0 < c.length && (b += "___" + Na(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), (c = b), (b = M(La, "_p", N())), (M(b, c, N())[a] = new Date().getTime()), Ma(a, "_p", c));
        },
        Na = function (a) {
    ...
    var Pa = /^(\/[a-zA-Z0-9_\-]+)+$/,
            ...
            try {
                ...
                if (e && 0 < e.length) {
                    ...
                    for (d = {}; c < e.length; ) {
                        ...
                        f = void 0;
                        k = typeof q;
                        f = ("object" == k && null != q) || "function" == k ? "o" + ((Object.prototype.hasOwnProperty.call(q, p) && q[p]) || (q[p] = ++ka)) : (typeof q).charAt(0) + q;
        ...
        $a = function (a, b, c, d) {
            a = Ya(a);
            Sa.test(c) || W("invalid_callback");
            b = Za(b);
            d = d && d.length ? Za(d) : null;
            var e = function (f) {
        ...
        Ya = function (a) {
            ...
            b = "/" + c.join("/");
            Pa.test(b) || W("invalid_prefix");
            c = 0;
            for (d = Qa.length; c < d; ++c) Qa[c].test(b) && W("invalid_prefix");
            c = X(a, "k", !0);
            d = X(a, "am");
            e = X(a, "rs");
            a = X(a, "t");
    ...
    var Y = decodeURI("%73cript"),
        ...
        cb = function () {
            var a = R.nonce;
            return void 0 !== a
                ? a && a === String(a) && a.match(ab)
                    ? a
                    : (R.nonce = null)
                : L.querySelector
                ? (a = L.querySelector("script[nonce]"))
                    ? ((a = a.nonce || a.getAttribute("nonce") || ""), a && a === String(a) && a.match(ab) ? (R.nonce = a) : (R.nonce = null))
                    : null
                : null;
        },
        eb = function (a) {
            if ("loading" != L.readyState) db(a);
            else {
                var b = cb(),
                    c = "";
                null !== b && (c = ' nonce="' + b + '"');
                a = "<" + Y + ' src="' + encodeURI(a) + '"' + c + "></" + Y + ">";
                L.write(Z ? Z.createHTML(a) : a);
            }
        },
        db = function (a) {
            var b = L.createElement(Y);
            b.setAttribute("src", Z ? Z.createScriptURL(a) : a);
            a = cb();
            null !== a && b.setAttribute("nonce", a);
            b.async = "true";
            (a = L.getElementsByTagName(Y)[0]) ? a.parentNode.insertBefore(b, a) : (L.head || L.body || L.documentElement).appendChild(b);
        },
        gb = function (a, b, c) {
            fb(function () {
                var d = b === Ia() ? M(Q, "_", N()) : N();
                d = M(S(b), "_", d);
                a(d);
            }, c);
        },
        ib = function (a, b) {
            ...
            if (!(a = c.h) && ((a = Ia()), !a)) throw Error("Bad hint: !hint");
            hb(b || [], c, a);
        },
        hb = function (a, b, c) {
            var d = !!R.glrp;
            ...
            var ca = M(S(c), "L", []).sort(),
                ...
                Ha = function (x, E) {
                    ...
                    K.clearTimeout(A);
                    ca.push.apply(ca, r);
                    var F = ((Q || {}).config || {}).update;
                    F ? F(f) : f && M(R, "cu", []).push(f);
                    if (E) {
                        U("me0", x, O);
                        try {
                            gb(E, c, q);
            ...
            if (r.length) {
                ...
                if (r.length) {
                    ...
                    a = Xa(c, r, "gapi." + da, l, nb);
                    l.push.apply(l, r);
                    U("ml0", r, O);
                    b.sync || K.___gapisync ? eb(a) : db(a);
                } else u[v](Ea);
            } else Ha(r) && e && e();
        },
        jb;
    var kb = null,
        lb = n.trustedTypes;
    if (lb && lb.createPolicy)
        try {
            kb = lb.createPolicy("gapi#gapi", { createHTML: t, createScript: t, createScriptURL: t });
        } catch (a) {
    ...
    Ka.bs0 = window.gapi._bs || new Date().getTime();
    Ma("bs0");
    Ka.bs1 = new Date().getTime();
    Ma("bs1");
